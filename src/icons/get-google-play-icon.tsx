export function GetGooglePlayIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <path
        ...
        strokeMiterlimit="10"
      />
      <g filter="url(#filter0_ii_601_74654)">
        <path
          d="M10.436 7.53784C10.145 7.84584 9.97299 8.32384 9.97299 8.94284V31.0588C9.97299 31.6788 10.145 32.1558 10.436 32.4638L10.51 32.5358L22.899 20.1468V20.0008V19.8548L10.51 7.46484L10.436 7.53784Z"
          fill="url(#paint0_linear_601_74654)"
        />
        <path
          d="M27.028 24.2779L22.899 20.1469V20.0009V19.8549L27.029 15.7249L27.122 15.7779L32.015 18.5579C33.412 19.3519 33.412 20.6509 32.015 21.4459L27.122 24.2259L27.028 24.2779Z"
          fill="url(#paint1_linear_601_74654)"
        />
        <g filter="url(#filter1_i_601_74654)">
          <path
            d="M27.122 24.225L22.898 20.001L10.436 32.464C10.896 32.952 11.657 33.012 12.514 32.526L27.122 24.225Z"
            fill="url(#paint2_linear_601_74654)"
          />
        </g>
        <path
          d="M27.122 15.7769L12.514 7.47694C11.657 6.98994 10.896 7.05094 10.436 7.53894L22.899 20.0019L27.122 15.7769Z"
          fill="url(#paint3_linear_601_74654)"
        />
      </g>
      <defs>
        <filter
          id="filter0_ii_601_74654"
          x="9.97299"
          y="7.14087"
          width="23.0898"
          height="25.7207"
        ...
        >
          ...
          <feBlend
            mode="normal"
            in2="shape"
            result="effect1_innerShadow_601_74654"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_innerShadow_601_74654"
            result="effect2_innerShadow_601_74654"
          />
        </filter>
        <filter
          id="filter1_i_601_74654"
          x="10.436"
          y="20.001"
          width="16.686"
          height="12.8606"
