export function LogoIcon({ ...props }: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      {...props}
    >
      <g filter="url(#filter0_dd_1454_967)">
        <g clip-path="url(#clip0_1454_967)">
          <path
          ...
          <path
            d="M3 14.8C3 10.3196 3 8.07937 3.87195 6.36808C4.63893 4.86278 5.86278 3.63893 7.36808 2.87195C9.07937 2 11.3196 2 15.8 2H22.2C26.6804 2 28.9206 2 30.6319 2.87195C32.1372 3.63893 33.3611 4.86278 34.1281 6.36808C35 8.07937 35 10.3196 35 14.8V21.2C35 25.6804 35 27.9206 34.1281 29.6319C33.3611 31.1372 32.1372 32.3611 30.6319 33.1281C28.9206 34 26.6804 34 22.2 34H15.8C11.3196 34 9.07937 34 7.36808 33.1281C5.86278 32.3611 4.63893 31.1372 3.87195 29.6319C3 27.9206 3 25.6804 3 21.2V14.8Z"
            fill="url(#paint0_linear_1454_967)"
          />
          <path
            fillRule="evenodd"
            clipRule="evenodd"
          ...
          <path
            ...
            fill="#D0D5DD"
          />
          <g filter="url(#filter1_dd_1454_967)">
            <circle cx="19" cy="18" r="8" fill="url(#paint1_linear_1454_967)" />
          </g>
          <g filter="url(#filter2_b_1454_967)">
            <path
      ...
      <defs>
        ...
        >
          ...
          <feBlend
            ...
            result="effect1_dropShadow_1454_967"
          />
          <feColorMatrix
            in="SourceAlpha"
            type="matrix"
          ...
          <feBlend
            mode="normal"
            in2="effect1_dropShadow_1454_967"
            result="effect2_dropShadow_1454_967"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect2_dropShadow_1454_967"
            result="shape"
          />
        </filter>
        <filter
          id="filter1_dd_1454_967"
          x="8"
          y="8"
          width="22"
          height="22"
        ...
        >
          ...
          <feComposite
            in2="SourceAlpha"
            operator="in"
            result="effect1_backgroundBlur_1454_967"
          />
          <feBlend
            mode="normal"
            in="SourceGraphic"
            in2="effect1_backgroundBlur_1454_967"
            result="shape"
          />
        </filter>
        <linearGradient
          id="paint0_linear_1454_967"
          x1="19"
          y1="2"
          x2="19"
          y2="34"
